...
async function fetchFeatures() {
  try {
    ...
    const response = await adoClient.post('/wit/wiql?api-version=7.0', {
      query: 'SELECT TOP 200 [System.Id], [System.Title], [System.State] FROM workitems WHERE [System.WorkItemType] = "Feature" AND [System.AreaPath] UNDER "Commercial Engineering" AND [System.State] IN ("New", "In Planning", "In Shaping", "In Process", "Planned")'
    });
